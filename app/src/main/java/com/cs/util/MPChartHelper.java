...
public class MPChartHelper {
     ...
     * @param bartitle2
     */
    public static void setTwoBarChart(BarChart barChart, List<Integer> xAxisValue, List<Float> yAxisValue1, List<Float> yAxisValue2, final List<String> list, String bartilte1, String bartitle2) {

        Log.i("TAG","x list -----"+ xAxisValue.get(0) + "----- y1 list  -----"+yAxisValue1.get(0)+ "-------y2 list -----"+yAxisValue2.get(0)+ "-------list ----"+list.get(0)+"-----title1 -----"+ bartilte1 +"------title2 ----"+bartitle2);
        barChart.getDescription().setEnabled(false);//设置描述
        barChart.setPinchZoom(true);//设置按比例放缩柱状图
        barChart.setExtraBottomOffset(10);
        barChart.setExtraTopOffset(30);
     ...
     * 设置柱状图数据源
     */
    public static void setTwoBarChartData(BarChart barChart, List<Integer> xAxisValue, List<Float> yAxisValue1, List<Float> yAxisValue2, String bartilte1, String bartitle2) {
        ...
        if (barChart.getData() != null && barChart.getData().getDataSetCount() > 0) {
            ...
            dataset1.setColor(Color.rgb(209, 103, 163));
